...
- Emotional goal: the relief of "it just worked and it's saved."

## Anti-references

- **The audio-editor / DAW look.** Knobs, meters, waveform timelines, transport bars,
  skeuomorphic tape. We are a capture tool, not Logic Pro.
- **Neon AI gradients + glassmorphism.** The predictable "AI transcription app" look:
  glowing gradient mic, blurred orbs, gradient text. Deliberately avoided.
- **Configuration-first.** No settings wall on first run. One key, then get out of the way.
